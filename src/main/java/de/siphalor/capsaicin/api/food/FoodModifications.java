...
public class FoodModifications {
	 ...
	 * @apiNote Never call {@link Item#getFoodProperties()} from within a properties modifier.
	 */
	 ...
	 * @apiNote Never call {@link ItemStack#getUseDuration()} from within an eating time modifier.
	 */
